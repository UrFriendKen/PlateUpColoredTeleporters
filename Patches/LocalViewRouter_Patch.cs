...
namespace KitchenColoredTeleporters.Patches
{
    [HarmonyPatch]
    static class LocalViewRouter_Patch
    {
        ...
        static readonly Type GENERIC_TYPE = typeof(TeleporterColorView.ViewData);
        const string DESCRIPTION = "Removed Specific Broadcast error logging for TeleporterColorView.ViewData"; // Logging purpose of patch
